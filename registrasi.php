...
<div class="container" align="center">
    <div align="center" style="width:400px;margin-top:5%;">
        ...
        <button type="submit" name="register" class="btn btn-block btn-success">Register New User</button>
        <a href="index.php" class="btn btn-block btn-info">Kembali ke halaman Login</a>
