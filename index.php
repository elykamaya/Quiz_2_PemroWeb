...
<div class="container" align="center">
    <div align="center" style="width:400px;margin-top:5%;">
        ...
        <h3 align="center"><span class="glyphicon glyphicon-home"></span> Form Login</h3>
        <hr>
        ...
        ?>
            <div class="form-group" align="left">
                ...
                <input type="text" class="form-control" id="username" placeholder="masukkan username anda" name="username" autocomplete="off" required>
            </div>
            <div class="form-group" align="left">
            ...
            <a href="registrasi.php" type="button" class="btn btn-block btn-primary">Register New User</a>
